...
inline void setImGuiStyle() {
  ...
  // ImGui Flags io.ConfigFlags |= ImGuiWindowFlags_AlwaysAutoResize;
  ...
  style.Colors[ImGuiCol_ScrollbarGrabActive] =
      ImVec4(0.30f, 0.33f, 0.37f, 1.00f);
  ...
  style.Colors[ImGuiCol_TabUnfocusedActive] =
      ImVec4(0.34f, 0.36f, 0.40f, 1.00f);
